...
<body>
  ...
  <div class="grid_3">
    <div class="container">
      ...
      <div class="grid_5">
        <p>Marital is eager to help you find your partner at the earliest. Our customer service team will be pleased to assist you anytime you have a query. You can contact our customer service team in one of the following ways.
        </p>
        <address class="addr row">
          <dl class="grid_4">
            <dt>Address :</dt>
            <dd>
            2B (3) II Ground Floor, Film Center Building, 68 Tardeo Road, Mumbai - 400 034, India.
          ...
          <dl class="grid_4">
            <dt>E-mail :</dt>
            <dd><a href="malito:akshbhujbal97@gmail.com">info@matrimony.com</a></dd>
          </dl>
        </address>
      </div>
    </div>
